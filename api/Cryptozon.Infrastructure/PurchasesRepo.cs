...
namespace Cryptozon.Infrastructure
{
  public class PurchasesRepo : IPurchasesRepo
  {
    ...
    public async Task<PurchaseConfirmation> PurchaseAsync(string userId,
    ...
    private Task PurchaseAsync(Guid reference, string userId, int coinId, decimal quantity, decimal unitPrice)
    {
    ...
    private Task GetAllPurchaseTasks(Guid reference, string userId,
